...
const DateInField = ({ value, onChange }) => {
    return (
        <>
            ...
            <FormControl
                type="date" value={value} onChange={onChange} name='dateIn'
            />
        </>
    );
};
...
const DateOutField = ({ value, onChange }) => {
    return (
        <>
            ...
            <FormControl
                type="date" value={value} onChange={onChange} dateOut
            />
        </>
    );
};
        ...
        <Container>
            <Form ref={form} onSubmit={sendEmail}>
                ...
                <Modal.Footer style={{display: "flex", width: "100%", justifyContent:"center"}}>
                    <Button variant="primary" type='submit' style={{width:"100%", margin: "20px 5px"}}>
                        Make Reservation
                    </Button>
                </Modal.Footer>
            </Form>
